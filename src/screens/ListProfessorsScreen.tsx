...
export default function ListProfessorsScreen({ navigation }: any) {
  ...
  async function handleDelete(id: number) {
    try {
      ...
      Alert.alert('Sucesso', 'Docente removido!');
      loadProfessors();
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity style={styles.addBtn} onPress={() => navigation.navigate('CreateEditProfessor')}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.itemRow}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('CreateEditProfessor', { id: item.id })}>
